...
function AssumptionsCatalogue({
  ...
  return (
    <svg
      ...
      width={width}
      height={height}
      fill={isHovered ? hoverFill : fill} // Change fill color on hover
      onMouseEnter={() => setIsHovered(true)} // Set hover state
      onMouseLeave={() => setIsHovered(false)} // Reset hover state
      style={{ transition: "fill 0.3s" }} // Smooth transition
    >
      ...
      <circle cx="20.05" cy="24.45" r="0.55" />
...
export default AssumptionsCatalogue;
