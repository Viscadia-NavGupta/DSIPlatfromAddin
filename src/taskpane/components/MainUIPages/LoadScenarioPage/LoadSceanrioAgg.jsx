...
const LoadScenarioAgg = ({ setPageValue }) => {
  ...
  const handleImportClick = async () => {
    ...
    try {
      ...
      if (Downloadflag && Downloadflag.status === "Scenario Imported") {
        ...
        setPageValue("SaveForecastPageinterim", "Some error occurred during import, please try again");
...
export default LoadScenarioAgg;
